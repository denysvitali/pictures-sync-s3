...
func TestIsRetryableNetworkError(t *testing.T) {
	tests := []struct {
		...
		{"dns server misbehaving", errors.New("lookup api.backblazeb2.com on [fd7a:115c:a1e0::53]:53: server misbehaving"), true},
		{"dns servfail", errors.New("dns: resolver: forward: SERVFAIL"), true},
		{"tailscale dns no upstream", errors.New("dns: resolver: forward: no upstream resolvers set, returning SERVFAIL"), true},
